...
func (s *Sqlite) GetItemsForAdmin(ctx context.Context, filter *models.QueryFilter) (*models.ItemList, error) {
...
func (s *Sqlite) GetItemsWithIDsForAdmin(ctx context.Context, limit uint8, ids []uint64) ([]models.Item, error) {
	if limit == 0 {
		limit = uint8(models.DefaultLimit)
	}

...
let translationsToUse = currentSessionSettings.getTranslations().components.dropdowns.userDropdown;
...
let superstore = new Superstore({
  ...
  sessionSettingsStoreUpdateFunc: (value: UserSiteSettings) => {
    ...
    translationsToUse = currentSessionSettings.getTranslations().components.dropdowns.userDropdown;
  },

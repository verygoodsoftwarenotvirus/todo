...
const infoBackgroundColor: string = "darkslategray";
const infoTextColor: string = defaultTextColor;

const debugPrefix: string = "%c  DEBUG  ";
const debugBackgroundColor: string = "rebeccapurple";
const debugTextColor: string = defaultTextColor;

const warningPrefix: string = "%c WARNING ";
const warningBackgroundColor: string = "goldenrod";
const warningTextColor: string = defaultTextColor;

const errorPrefix: string = "%c  ERROR  ";
const errorBackgroundColor: string = "firebrick";
const errorTextColor: string = defaultTextColor;

const wtfPrefix: string = "%c   WTF   ";
const wtfBackgroundColor: string = "palegreen";
const wtfTextColor: string = "rosybrown";

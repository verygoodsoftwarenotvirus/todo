...
export function login(loginCreds: LoginRequest): Promise<AxiosResponse> {
  ...
  return axios
    .post(uri, loginCreds, defaultAPIRequestConfig)
    .then(requestLogFunction(logger, uri));
}
...
export function validateTOTPSecretWithToken(
  ...
  return axios
    .post(uri, validationRequest, defaultAPIRequestConfig)
    .then(requestLogFunction(logger, uri));
}
...
export function registrationRequest(
  ...
  return axios
    .post(uri, rr, defaultAPIRequestConfig)
    .then(requestLogFunction(logger, uri));
}
...
export function passwordChangeRequest(
  ...
  return axios
    .put(uri, pcr, defaultAPIRequestConfig)
    .then(requestLogFunction(logger, uri));
}
...
export function twoFactorSecretChangeRequest(
  ...
  return axios
    .post(uri, sur, defaultAPIRequestConfig)
    .then(requestLogFunction(logger, uri));
}

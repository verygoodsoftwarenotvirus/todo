...
func (s *Service) buildUsersTableView(includeBaseTemplate bool) func(http.ResponseWriter, *http.Request) {
...
func (s *Service) buildUserSearchResults(includeBaseTemplate bool) func(http.ResponseWriter, *http.Request) {
	return func(res http.ResponseWriter, req *http.Request) {
		ctx, span := s.tracer.StartSpan(req.Context())
		defer span.End()

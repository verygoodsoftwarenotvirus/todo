...
func (b *MariaDB) BuildGetAccountQuery(ctx context.Context, accountID, userID string) (query string, args []interface{}) {
...
func (b *MariaDB) BuildGetAllAccountsCountQuery(ctx context.Context) string {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MariaDB) BuildGetBatchOfAccountsQuery(ctx context.Context, beginID, endID uint64) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MariaDB) BuildGetAccountsQuery(ctx context.Context, userID string, forAdmin bool, filter *types.QueryFilter) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MariaDB) BuildAccountCreationQuery(ctx context.Context, input *types.AccountCreationInput) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MariaDB) BuildUpdateAccountQuery(ctx context.Context, input *types.Account) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MariaDB) BuildArchiveAccountQuery(ctx context.Context, accountID, userID string) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MariaDB) BuildGetAuditLogEntriesForAccountQuery(ctx context.Context, accountID string) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()

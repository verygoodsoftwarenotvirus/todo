...
func TestMySQL_BuildGetDefaultAccountIDForUserQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildUserIsMemberOfAccountQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildAddUserToAccountQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildRemoveUserFromAccountQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildArchiveAccountMembershipsForUserQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildCreateMembershipForNewUserQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildGetAccountMembershipsForUserQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildMarkAccountAsUserDefaultQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildModifyUserPermissionsQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildTransferAccountOwnershipQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildTransferAccountMembershipsQuery(T *testing.T) {
	T.Parallel()

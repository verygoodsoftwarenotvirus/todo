...
func TestMySQL_BuildGetAccountQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildGetAllAccountsCountQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildGetBatchOfAccountsQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildGetAccountsQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildCreateAccountQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("standard", func(t *testing.T) {
		...
		expectedQuery := "INSERT INTO accounts (id,name,billing_status,contact_email,contact_phone,belongs_to_user) VALUES (?,?,?,?,?,?)"
		expectedArgs := []interface{}{
			exampleInput.ID,
			exampleAccount.Name,
...
func TestMySQL_BuildUpdateAccountQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("standard", func(t *testing.T) {
		...
		expectedQuery := "UPDATE accounts SET name = ?, contact_email = ?, contact_phone = ?, last_updated_on = UNIX_TIMESTAMP() WHERE archived_on IS NULL AND belongs_to_user = ? AND id = ?"
		expectedArgs := []interface{}{
			exampleAccount.Name,
			exampleAccount.ContactEmail,
			exampleAccount.ContactPhone,
...
func TestMySQL_BuildArchiveAccountQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildGetAuditLogEntriesForAccountQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("standard", func(t *testing.T) {
		...
		expectedQuery := fmt.Sprintf("SELECT audit_log.id, audit_log.event_type, audit_log.context, audit_log.created_on FROM audit_log WHERE JSON_CONTAINS(audit_log.context, '%q', '$.account_id') ORDER BY audit_log.created_on", exampleAccount.ID)

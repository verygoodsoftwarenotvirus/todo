...
func TestMySQL_BuildGetAuditLogEntryQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildGetAllAuditLogEntriesCountQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildGetBatchOfAuditLogEntriesQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildGetAuditLogEntriesQuery(T *testing.T) {
	T.Parallel()
...
func TestMySQL_BuildCreateAuditLogEntryQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("standard", func(t *testing.T) {
		...
		expectedQuery := "INSERT INTO audit_log (id,event_type,context) VALUES (?,?,?)"
		expectedArgs := []interface{}{
			exampleAuditLogEntry.ID,

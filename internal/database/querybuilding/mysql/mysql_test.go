...
func buildTestService(t *testing.T) (*MySQL, sqlmock.Sqlmock) {
	t.Helper()

	_, mock, err := sqlmock.New()
	require.NoError(t, err)

	return ProvideMySQL(logging.NewNoopLogger()), mock
}
...
func TestProvideMySQL(T *testing.T) {
	T.Parallel()
...
func TestMySQL_logQueryBuildingError(T *testing.T) {
	T.Parallel()
...
func TestProvideMySQLConnection(T *testing.T) {
	T.Parallel()

	T.Run("standard", func(t *testing.T) {
		t.Parallel()

		_, err := ProvideMySQLConnection(logging.NewNoopLogger(), "")

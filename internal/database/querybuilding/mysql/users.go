...
var (
	_ querybuilding.UserSQLQueryBuilder = (*MySQL)(nil)
)

// BuildUserHasStatusQuery returns a SQL query (and argument) for retrieving a user by their database ID.
func (b *MySQL) BuildUserHasStatusQuery(ctx context.Context, userID string, statuses ...string) (query string, args []interface{}) {
...
func (b *MySQL) BuildGetUserQuery(ctx context.Context, userID string) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildGetUserWithUnverifiedTwoFactorSecretQuery(ctx context.Context, userID string) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildGetUserByUsernameQuery(ctx context.Context, username string) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildSearchForUserByUsernameQuery(ctx context.Context, usernameQuery string) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildGetAllUsersCountQuery(ctx context.Context) (query string) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildGetUsersQuery(ctx context.Context, filter *types.QueryFilter) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildTestUserCreationQuery(ctx context.Context, testUserConfig *types.TestUserCreationConfig) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
	...
	return b.buildQuery(
		...
		b.sqlBuilder.Insert(querybuilding.UsersTableName).
			Columns(
				...
				querybuilding.UsersTableReputationExplanationColumn,
				querybuilding.UsersTableAvatarColumn,
				querybuilding.CreatedOnColumn,
			).
			Values(
				testUserConfig.ID,
...
func (b *MySQL) BuildUserCreationQuery(ctx context.Context, input *types.UserDataStoreCreationInput) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildUpdateUserQuery(ctx context.Context, input *types.User) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildSetUserStatusQuery(ctx context.Context, input *types.UserReputationUpdateInput) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildUpdateUserPasswordQuery(ctx context.Context, userID, newHash string) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildUpdateUserTwoFactorSecretQuery(ctx context.Context, userID, newSecret string) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildVerifyUserTwoFactorSecretQuery(ctx context.Context, userID string) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildArchiveUserQuery(ctx context.Context, userID string) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()

...
var (
	_ querybuilding.WebhookSQLQueryBuilder = (*MySQL)(nil)
)

// BuildGetWebhookQuery returns a SQL query (and arguments) for retrieving a given webhook.
func (b *MySQL) BuildGetWebhookQuery(ctx context.Context, webhookID, accountID string) (query string, args []interface{}) {
...
func (b *MySQL) BuildGetAllWebhooksCountQuery(ctx context.Context) string {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildGetBatchOfWebhooksQuery(ctx context.Context, beginID, endID uint64) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildGetWebhooksQuery(ctx context.Context, accountID string, filter *types.QueryFilter) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildCreateWebhookQuery(ctx context.Context, x *types.WebhookCreationInput) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildUpdateWebhookQuery(ctx context.Context, input *types.Webhook) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildArchiveWebhookQuery(ctx context.Context, webhookID, accountID string) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *MySQL) BuildGetAuditLogEntriesForWebhookQuery(ctx context.Context, webhookID string) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()

...
type (
	...
	AccountSQLQueryBuilder interface {
		BuildGetAccountQuery(ctx context.Context, accountID, userID string) (query string, args []interface{})
	...
	AccountUserMembershipSQLQueryBuilder interface {
		BuildGetDefaultAccountIDForUserQuery(ctx context.Context, userID string) (query string, args []interface{})
		BuildArchiveAccountMembershipsForUserQuery(ctx context.Context, userID string) (query string, args []interface{})
		BuildGetAccountMembershipsForUserQuery(ctx context.Context, userID string) (query string, args []interface{})
		BuildMarkAccountAsUserDefaultQuery(ctx context.Context, userID, accountID string) (query string, args []interface{})
		BuildModifyUserPermissionsQuery(ctx context.Context, userID, accountID string, newRoles []string) (query string, args []interface{})
		BuildTransferAccountMembershipsQuery(ctx context.Context, currentOwnerID, newOwnerID, accountID string) (query string, args []interface{})
		BuildUserIsMemberOfAccountQuery(ctx context.Context, userID, accountID string) (query string, args []interface{})
		BuildCreateMembershipForNewUserQuery(ctx context.Context, userID, accountID string) (query string, args []interface{})
		BuildAddUserToAccountQuery(ctx context.Context, input *types.AddUserToAccountInput) (query string, args []interface{})
		BuildRemoveUserFromAccountQuery(ctx context.Context, userID, accountID string) (query string, args []interface{})
	}
	...
	APIClientSQLQueryBuilder interface {
		...
		BuildGetAPIClientByDatabaseIDQuery(ctx context.Context, clientID, userID string) (query string, args []interface{})
	...
	UserSQLQueryBuilder interface {
		BuildUserHasStatusQuery(ctx context.Context, userID string, statuses ...string) (query string, args []interface{})
		BuildGetUserQuery(ctx context.Context, userID string) (query string, args []interface{})
		BuildGetUsersQuery(ctx context.Context, filter *types.QueryFilter) (query string, args []interface{})
		BuildGetUserWithUnverifiedTwoFactorSecretQuery(ctx context.Context, userID string) (query string, args []interface{})
		...
		BuildUserCreationQuery(ctx context.Context, input *types.UserDataStoreCreationInput) (query string, args []interface{})
		BuildUpdateUserQuery(ctx context.Context, input *types.User) (query string, args []interface{})
		BuildUpdateUserPasswordQuery(ctx context.Context, userID, newHash string) (query string, args []interface{})
	...
	WebhookSQLQueryBuilder interface {
		BuildGetWebhookQuery(ctx context.Context, webhookID, accountID string) (query string, args []interface{})

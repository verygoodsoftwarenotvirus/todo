...
func (b *Sqlite) BuildGetAllAccountsCountQuery(ctx context.Context) string {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *Sqlite) BuildGetBatchOfAccountsQuery(ctx context.Context, beginID, endID uint64) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *Sqlite) BuildAccountCreationQuery(ctx context.Context, input *types.AccountCreationInput) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()
...
func (b *Sqlite) BuildUpdateAccountQuery(ctx context.Context, input *types.Account) (query string, args []interface{}) {
	_, span := b.tracer.StartSpan(ctx)
	defer span.End()

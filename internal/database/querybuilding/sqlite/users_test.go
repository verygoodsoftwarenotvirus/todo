...
func TestSqlite_BuildTestUserCreationQuery(T *testing.T) {
	...
	T.Run("standard", func(t *testing.T) {
		...
		expectedQuery := "INSERT INTO users (external_id,username,hashed_password,two_factor_secret,reputation,service_role,two_factor_secret_verified_on) VALUES (?,?,?,?,?,?,(strftime('%s','now')))"
		expectedArgs := []interface{}{
			fakeUUID,
...
func TestSqlite_BuildCreateUserQuery(T *testing.T) {
	...
	T.Run("standard", func(t *testing.T) {
		...
		expectedQuery := "INSERT INTO users (external_id,username,hashed_password,two_factor_secret,reputation,service_role) VALUES (?,?,?,?,?,?)"
		expectedArgs := []interface{}{

...
func TestMariaDB_ScanAccounts(T *testing.T) {
	T.Parallel()
...
func TestMariaDB_AccountExists(T *testing.T) {
	T.Parallel()
...
func TestMariaDB_GetAccount(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		q, mockDB := buildTestService(t)
		expectedQuery, expectedArgs := q.buildGetAccountQuery(exampleAccount.ID, exampleAccount.BelongsToUser)
...
func TestMariaDB_GetAllAccountsCount(T *testing.T) {
	T.Parallel()
...
func TestMariaDB_GetAllAccounts(T *testing.T) {
	T.Parallel()
...
func TestMariaDB_GetAccounts(T *testing.T) {
	T.Parallel()
...
func TestMariaDB_GetAccountsForAdmin(T *testing.T) {
	T.Parallel()
...
func TestMariaDB_CreateAccount(T *testing.T) {
	T.Parallel()
...
func TestMariaDB_buildUpdateAccountQuery(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedQuery := "UPDATE accounts SET name = ?, last_updated_on = UNIX_TIMESTAMP() WHERE belongs_to_user = ? AND id = ?"
		expectedArgs := []interface{}{
			exampleAccount.Name,
			exampleAccount.BelongsToUser,
			exampleAccount.ID,
...
func TestMariaDB_UpdateAccount(T *testing.T) {
	T.Parallel()
...
func TestMariaDB_ArchiveAccount(T *testing.T) {
	T.Parallel()
...
func TestMariaDB_buildGetAuditLogEntriesForAccountQuery(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedQuery := fmt.Sprintf("SELECT audit_log.id, audit_log.event_type, audit_log.context, audit_log.created_on FROM audit_log WHERE JSON_CONTAINS(audit_log.context, '%d', '$.account_id') ORDER BY audit_log.created_on", exampleAccount.ID)
...
func TestMariaDB_GetAuditLogEntriesForAccount(T *testing.T) {
	T.Parallel()

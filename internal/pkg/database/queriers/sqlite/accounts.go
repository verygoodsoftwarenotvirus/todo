...
func (q *Sqlite) scanAccount(scan database.Scanner, includeCount bool) (*types.Account, uint64, error) {
	var (
		x     = &types.Account{}
		count uint64
	)
...
func (q *Sqlite) buildGetAccountsQuery(userID uint64, filter *types.QueryFilter) (query string, args []interface{}) {
...
// and returns both the query and the relevant args to pass to the query executor.
func (q *Sqlite) buildGetAccountsForAdminQuery(filter *types.QueryFilter) (query string, args []interface{}) {
	if filter == nil {

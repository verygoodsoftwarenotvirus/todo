...
func (q *Sqlite) ItemExists(ctx context.Context, itemID, userID uint64) (exists bool, err error) {
...
func (q *Sqlite) GetItem(ctx context.Context, itemID, userID uint64) (*types.Item, error) {
...
func (q *Sqlite) GetAllItemsCount(ctx context.Context) (count uint64, err error) {
...
func (q *Sqlite) buildGetItemsQuery(userID uint64, filter *types.QueryFilter) (query string, args []interface{}) {
...
func (q *Sqlite) GetItems(ctx context.Context, userID uint64, filter *types.QueryFilter) (*types.ItemList, error) {
...
// and returns both the query and the relevant args to pass to the query executor.
func (q *Sqlite) buildGetItemsForAdminQuery(filter *types.QueryFilter) (query string, args []interface{}) {
	if filter == nil {
...
func (q *Sqlite) GetItemsForAdmin(ctx context.Context, filter *types.QueryFilter) (*types.ItemList, error) {
...
func (q *Sqlite) buildGetItemsWithIDsQuery(userID uint64, limit uint8, ids []uint64) (query string, args []interface{}) {
	var (
		err               error
...
// are valid database IDs, because there's no way in squirrel to escape them in the unnest join,
// and if we accept strings we could leave ourselves vulnerable to SQL injection attacks.
func (q *Sqlite) buildGetItemsWithIDsForAdminQuery(limit uint8, ids []uint64) (query string, args []interface{}) {
	var (
		err               error
		whenThenStatement string
	)
...
func (q *Sqlite) buildCreateItemQuery(input *types.Item) (query string, args []interface{}) {
	var err error
...
func (q *Sqlite) CreateItem(ctx context.Context, input *types.ItemCreationInput) (*types.Item, error) {
	x := &types.Item{
		Name:          input.Name,
...
func (q *Sqlite) UpdateItem(ctx context.Context, input *types.Item) error {
...
func (q *Sqlite) ArchiveItem(ctx context.Context, itemID, userID uint64) error {
...
func (q *Sqlite) LogItemCreationEvent(ctx context.Context, item *types.Item) {
...
func (q *Sqlite) LogItemUpdateEvent(ctx context.Context, userID, itemID uint64, changes []types.FieldChangeSummary) {
...
func (q *Sqlite) LogItemArchiveEvent(ctx context.Context, userID, itemID uint64) {

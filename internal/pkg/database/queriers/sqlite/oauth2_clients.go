...
func (q *Sqlite) scanOAuth2Client(scan database.Scanner, includeCount bool) (*types.OAuth2Client, uint64, error) {
	var (
...
func (q *Sqlite) scanOAuth2Clients(rows database.ResultIterator, includeCount bool) ([]*types.OAuth2Client, uint64, error) {
	var (
...
func (q *Sqlite) GetOAuth2ClientByClientID(ctx context.Context, clientID string) (*types.OAuth2Client, error) {
...
func (q *Sqlite) buildGetAllOAuth2ClientsQuery() (query string) {
	var err error
...
func (q *Sqlite) GetAllOAuth2Clients(ctx context.Context) ([]*types.OAuth2Client, error) {
...
func (q *Sqlite) GetAllOAuth2ClientsForUser(ctx context.Context, userID uint64) ([]*types.OAuth2Client, error) {
...
func (q *Sqlite) GetOAuth2Client(ctx context.Context, clientID, userID uint64) (*types.OAuth2Client, error) {
...
func (q *Sqlite) GetAllOAuth2ClientCount(ctx context.Context) (uint64, error) {
	var count uint64
...
func (q *Sqlite) buildGetOAuth2ClientsForUserQuery(userID uint64, filter *types.QueryFilter) (query string, args []interface{}) {
...
func (q *Sqlite) GetOAuth2ClientsForUser(ctx context.Context, userID uint64, filter *types.QueryFilter) (*types.OAuth2ClientList, error) {
...
func (q *Sqlite) buildCreateOAuth2ClientQuery(input *types.OAuth2Client) (query string, args []interface{}) {
	var err error
...
func (q *Sqlite) CreateOAuth2Client(ctx context.Context, input *types.OAuth2ClientCreationInput) (*types.OAuth2Client, error) {
	x := &types.OAuth2Client{
		Name:          input.Name,
...
func (q *Sqlite) UpdateOAuth2Client(ctx context.Context, input *types.OAuth2Client) error {
...
func (q *Sqlite) ArchiveOAuth2Client(ctx context.Context, clientID, userID uint64) error {
...
func (q *Sqlite) LogOAuth2ClientCreationEvent(ctx context.Context, client *types.OAuth2Client) {
...
func (q *Sqlite) LogOAuth2ClientArchiveEvent(ctx context.Context, userID, clientID uint64) {

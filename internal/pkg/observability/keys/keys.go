...
const (
	...
	// QueryKey is the standard key for referring to a .
	QueryKey = "query"
	// ConnectionDetailsKey is the standard key for referring to a .
	...
	// QueryErrorKey is the stnadard key for referring to a .
	QueryErrorKey = "QUERY_ERROR"
	// RowIDErrorKey is the stnadard key for referring to a .

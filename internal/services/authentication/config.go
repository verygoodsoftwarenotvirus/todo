...
type (
	...
	CookieConfig struct {
		...
		HashKey    string        `json:"hashKey" mapstructure:"hash_key" toml:"hash_key,omitempty"`
		SigningKey string        `json:"signingKey" mapstructure:"signing_key" toml:"signing_key,omitempty"`
		Lifetime   time.Duration `json:"lifetime" mapstructure:"lifetime" toml:"lifetime,omitempty"`
		SecureOnly bool          `json:"secureOnly" mapstructure:"secure_only" toml:"secure_only,omitempty"`
	}

	// PASETOConfig holds our PASETO settings.
	PASETOConfig struct {
		Issuer       string        `json:"issuer" mapstructure:"issuer" toml:"issuer,omitempty"`
		LocalModeKey []byte        `json:"localModeKey" mapstructure:"local_mode_key" toml:"local_mode_key,omitempty"`
		Lifetime     time.Duration `json:"lifetime" mapstructure:"lifetime" toml:"lifetime,omitempty"`
	}
	...
	Config struct {
		...
		EnableUserSignup      bool         `json:"enableUserSignup" mapstructure:"enable_user_signup" toml:"enable_user_signup,omitempty"`
		MinimumUsernameLength uint8        `json:"minimumUsernameLength" mapstructure:"minimum_username_length" toml:"minimum_username_length,omitempty"`
		MinimumPasswordLength uint8        `json:"minimumPasswordLength" mapstructure:"minimum_password_length" toml:"minimum_password_length,omitempty"`
	}
)

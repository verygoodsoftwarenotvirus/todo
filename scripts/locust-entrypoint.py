# https://github.com/sernst/locusts/blob/682da15c6a53879c4af6875c6ce73899e82e9d6a/run.py
...
def run():
    args = make_command(parse())

    print(args)
    print(os.getcwd())

    process = subprocess.Popen(
        args=args, stdout=sys.stdout, shell=True, universal_newlines=True
    )
